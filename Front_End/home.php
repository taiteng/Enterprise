<head>
    ...
    <meta name="description" content="Event Website Template Website Builder">
    <title>Event Website Template</title>
...
<body>
        ...
        <div class="container">
            <div class="mbr-row mbr-justify-content-center">
                <div class="mbr-col-lg-6 mbr-col-md-12 resizeblock vcenter">
                    <h1 class="mbr-fonts-style mbr-white align-right mbr-bold display-1">Event Planning System by Covent.Co</h1>
                    <div class="mbr-text align-right">
                        <p class="mbr-text mbr-white mbr-fonts-style display-7">
                            Book a service with us. We help to organize and decorate your events.
                        </p>
                    </div>
                    <div class="mbr-section-btn align-right"><a class="btn btn-lg btn-white display-6" href="service_details.php">BOOK NOW</a></div>
                </div>
    ...
    <amp-animation layout="nodisplay" trigger="visibility" class="cid-qMPH9a8DBF" id="features15-3" data-rv-view="6051">
        <script type="application/json">
        {
    ...
    <section class="features15 cid-qMPH9a8DBF" id="features15-3">
        <div class="animated-text display-1">COVENT</div>
        <div class="mbr-overlay"></div>
        <div class="container">
            <h1 class="mbr-section-title mbr-fonts-style align-center mbr-bold mbr-black l-spacing3 display-1">Event Planning System</h1>
            <p class="mbr-fonts-style mbr-text align-center mbr-black display-4">
                Serves the users by organizing and decorating the events.
            </p>
        </div>
    </section>

    <section class="timeline1 cid-qMPIVqjzNp" id="timeline1-4">
        <div class="container">
            <div class="mbr-row mbr-justify-content-center">
                <div class="mbr-col-md-6 border">
                    <h1 class="mbr-fonts-style main-title mbr-black align-center mbr-bold display-2">PROCESS</h1>
                    <h3 class="mbr-fonts-style main-subtitle mbr-black align-center display-3">How to book a service?
                        <div>
                            <br>
                        </div>
                    </h3>
                </div>
                <div class="mbr-row rowrev">
                    <div class="mbr-col-md-5 mbr-col-sm-8">
                        <h2 class="mbr-fonts-style bg title-col1 card-title mbr-black align-right mbr-bold display-5">Insert service details</h2>
                        <div class="mbr-text align-left">
                            <p class="mbr-text textcol1 mbr-fonts-style mbr-white align-right display-7">Customers are to insert details on event, venue and items needed.</p>
                        </div>
                    </div>
                    <div class="mbr-col-md-2 hcenter relative">
                        <div class="line">
                        </div>
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-comments fa"></span>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-col-md-5">
                        <p class="mbr-text date dateapp mbr-fonts-style align-left display-4">Step 1</p>
                    </div>
                </div>
                <div class="mbr-row">
                    <div class="mbr-col-md-5">
                        <p class="mbr-text date dateapp mbr-fonts-style align-right display-4">Step 2</p>
                    </div>
                    <div class="mbr-col-md-2 relative hcenter">
                        <div class="line"></div>
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                ...
                <div class="mbr-row rowrev">
                    <div class="mbr-col-md-5 mbr-col-sm-8">
                        <h2 class="mbr-fonts-style bg title-col1 card-title mbr-black align-right mbr-bold display-5">Deposit for Payment</h2>
                        <div class="mbr-text align-left">
                            <p class="mbr-text textcol1 mbr-fonts-style mbr-white align-right display-7">Pay deposit upfront, then the rest after the service is done. Deposit will be half of the total price.</p>
                        </div>
                    </div>
                    <div class="mbr-col-md-2 hcenter relative">
                        <div class="line"></div>
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-cutlery fa"></span>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-col-md-5">
                        <p class="mbr-text date dateapp mbr-fonts-style align-left display-4">Step 3</p>
                    </div>
                </div>
                <div class="mbr-row">
                    <div class="mbr-col-md-5">
                        <p class="mbr-text date dateapp mbr-fonts-style align-right display-4">Step 4</p>
                    </div>
                    <div class="mbr-col-md-2 relative hcenter">
                        <div class="line"></div>
                        <div class="padding-top">
                    ...
                    <div class="mbr-col-md-5 mbr-col-sm-8">
                        <h2 class="mbr-fonts-style bg titlecol2 card-title mbr-black align-left mbr-bold display-5">Wait for Results</h2>
                        <div class="mbr-text align-right">
                            <p class="mbr-text textcol2 mbr-fonts-style mbr-white align-left display-7">Just wait and we will send a team to do the decoration of your venue.</p>
                        </div>
                    </div>
                </div>
                <div class="mbr-row rowrev">
                    <div class="mbr-col-md-5 mbr-col-sm-8">
                        <h2 class="mbr-fonts-style bg title-col1 card-title mbr-black align-right mbr-bold display-5">Make Full Payment</h2>
                        <div class="mbr-text align-left">
                            <p class="mbr-text textcol1 mbr-fonts-style mbr-white align-right display-7">After the service is done, customers are to give the rest of the payment to the team sent.</p>
                        </div>
                    </div>
                    <div class="mbr-col-md-2 hcenter relative">
                        <div class="line"></div>
                    ...
                    <div class="mbr-col-md-5">
                        <p class="mbr-text date dateapp mbr-fonts-style align-left display-4">Step 5</p>
                    </div>
                </div>
                <div class="mbr-col-lg-3 mbr-col-md-6 mbr-col-sm-12 border">
                    <h1 class="mbr-fonts-style end mbr-black align-center mbr-bold display-5">THE END</h1>
                </div>
            </div>
        </div>
    </section>
    
    <section class="features6 mbr-section cid-qMPH4XrIy9" id="features6-2">
        <div class="container">
            <h1 class="mbr-fonts-style main-title mbr-black align-center mbr-bold display-2" style="margin-bottom: 100px">Terms & Conditions</h1>
            <div class="mbr-row mbr-justify-content-center">
                <div class="card mbr-col-sm-12 mbr-col-md-12 mbr-col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-box">
                            <div class="wrap">
                                <h4 class="card-count mbr-fonts-style align-left display-1">01</h4>
                            </div>
                            <p class="mbr-text mbr-fonts-style align-left display-7">
                                The organizers of the master class choose simple dishes so that children can cook them themselves: pizza, short-pastry biscuits, sweet rolls, baking decorations, homemade sweets, etc.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card mbr-col-sm-12 mbr-col-md-12 mbr-col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-box">
                            <div class="wrap">
                                <h4 class="card-count mbr-fonts-style align-left display-1">02</h4>
                            </div>
                            <p class="mbr-text mbr-fonts-style align-left display-7">
                                The organizers define the theme for the master class after they personally meet with the guests and find out their interests. For babies choose simple but delicious and favorite dishes: sweet rolls, pancakes, cakes, fruit salads, etc.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card mbr-col-sm-12 mbr-col-md-12 mbr-col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-box">
                            <div class="wrap">
                                <h4 class="card-count mbr-fonts-style align-left display-1">03</h4>
                            </div>
                            <p class="mbr-text mbr-fonts-style align-left display-7">
                                The organizers define the theme for the master class after they personally meet with the guests and find out their interests. For babies choose simple but delicious and favorite dishes: sweet rolls, pancakes, cakes, fruit salads, etc.
                            </p>
                ...
                <div class="card mbr-col-sm-12 mbr-col-md-12 mbr-col-lg-4 last-child">
                    <div class="card-wrapper">
                        <div class="card-box">
                            <div class="wrap">
                                <h4 class="card-count mbr-fonts-style align-left display-1">04</h4>
                            </div>
                            <p class="mbr-text mbr-fonts-style align-left display-7">
                                The participants of the event have the opportunity to sing children's songs in karaoke. At the request of the parents we apply aquagrim to the kids, we will organize a chemical show for them.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info3 cid-qMPJXF6cFc" id="info3-6">
        <div class="mbr-overlay"></div>
        <div class="container">
            <div class="mbr-row mbr-justify-content-center">
                <div class="mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-8">
                    ...
                    <div>LOOK AT OUR REVIEWS<br></div></h2>
                    <h3 class="mbr-section-subtitle align-left mbr-fonts-style mbr-light display-3">Reviews left by customers who tried our service!</h3>
                </div>
                <div class="btn-container align-center mbr-col-sm-12 mbr-col-md-4 mbr-col-lg-4">
                    <div class="mbr-section-btn"><a class="btn btn-white display-6" href="reviews.php">WARP</a></div>
                </div>
            </div>
        </div>
    </section>
