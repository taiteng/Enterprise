...
<body>
            ...
            <div class="mbr-row mbr-justify-content-center">
                    ...
                    <div class="mbr-col-md-2 hcenter relative">
                        ...
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-comments fa" style="color:#000066"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mbr-row">
                    ...
                    <div class="mbr-col-md-2 relative hcenter">
                        ...
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-file-text-o fa" style="color:#000066"></span>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-col-md-5 mbr-col-sm-8">
                ...
                <div class="mbr-row rowrev">
                    ...
                    <div class="mbr-col-md-2 hcenter relative">
                        ...
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-cc-paypal fa" style="color:#000066"></span>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-col-md-5">
                ...
                <div class="mbr-row">
                    ...
                    <div class="mbr-col-md-2 relative hcenter">
                        ...
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-thumbs-o-up fa" style="color:#000066"></span>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-col-md-5 mbr-col-sm-8">
                ...
                <div class="mbr-row rowrev">
                    ...
                    <div class="mbr-col-md-2 hcenter relative">
                        ...
                        <div class="padding-top">
                            <div class="card-img relative iconbox">
                                <span class="mbr-iconfont fa-trophy fa" style="color:#000066"></span>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-col-md-5">
    ...
    <section class="features6 mbr-section cid-qMPH4XrIy9" id="features6-2">
        <div class="container">
            ...
            <div class="mbr-row mbr-justify-content-center TNCBody">
