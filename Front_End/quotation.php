...
<html>
    ...
    <body>
        ...
        <section style="background-color: #999999;">
            <center>
                <form action="../Back_End/quotation_accept.php" method="POST" style="display: inline-block;">
                    ...
                    <button type="submit" class="btn btn-success display-6">Accept</button>
                </form>
                <form action="../Back_End/quotation_reject.php" method="POST" style="display: inline-block;">
                    <input type="hidden" name="serviceID" value="<?php echo $service_data['service_id']; ?>">
                    <button type="submit" class="btn btn-warning display-6">Reject</button>
                </form>
            </center>
        ...
        <section class="features6 mbr-section cid-qMPH4XrIy9" id="features6-2">
            <div class="container">
                <h1 class="mbr-fonts-style main-title mbr-black align-center mbr-bold display-2">Add Review</h1>
