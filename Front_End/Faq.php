    ...
    <body>
        ...
        <section class="header2 cid-qMPFA6jKDg mbr-fullscreen" id="header2-1">
            ...
            <div class="container">
                ...
                <h3 class="text-center text-black mb-4 text-primary fw-bold display-2">FAQ</h3>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-4">
                        <h6 class="mb-3 text-primary"><i class="fas fa-paper-plane text-primary"></i> A simple question?</h6>
                        <p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <h6 class="mb-3 text-primary"><i class="fas fa-pen-alt text-primary"></i> A question that is longer then the previous one?</h6>
                        <p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <h6 class="mb-3 text-primary"><i class="fas fa-user text-primary"></i> A simple question?</h6>
                        <p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <h6 class="mb-3 text-primary"><i class="fas fa-rocket text-primary"></i> A simple question?</h6>
                        <p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <h6 class="mb-3 text-primary"><i class="fas fa-home text-primary"></i> Can I request refund on deposit?</h6>
                        <p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <h6 class="mb-3 text-primary"><i class="fas fa-book-open text-primary"></i> Another question that is longer than usual</h6>
                        <p>
